...
export default function DocumentPreview({ html, sessionId, onHome }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 relative">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-slate-200 z-10 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 hover:shadow-md transition-all active:scale-95"
          >
      ...
      {/* Canvas Area */}
      <div className="flex-1 overflow-y-auto p-8 lg:p-12 scroll-smooth bg-gray-100">
        <div className="max-w-[800px] mx-auto bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] ring-1 ring-slate-900/5 rounded-sm min-h-[1056px] p-[72px] transition-all">
          <style>{`
            .resume-content {
              color: #1e293b;
